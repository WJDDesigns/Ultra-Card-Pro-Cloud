"use strict";(self.webpackChunkultra_card=self.webpackChunkultra_card||[]).push([[840],{8840(o,t,r){r.r(t),r.d(t,{HubColorsTab:()=>g});var i=r(5183),e=r(4276),s=r(9286);class a{constructor(){this._favorites=[],this._listeners=new Set,this._instanceId=`inst-${Date.now()}-${Math.random().toString(36).substr(2,9)}`,this._isBroadcasting=!1,this._hass=null,this._haLoaded=!1,this._logged404=!1,this._integrationMissing=!1,this._loadPromise=null,this._loadFromStorage(),this._setupStorageListener()}getFavorites(){return[...this._favorites].sort((o,t)=>o.order-t.order)}addFavorite(o,t){const r={id:this._generateId(),name:o.trim(),color:t,order:this._getNextOrder()};return this._favorites.push(r),this._saveToStorage(),this._notifyListeners(),this._broadcastChange(),this._syncToHAIfAvailable(),r}updateFavorite(o,t){var r;const i=this._favorites.findIndex(t=>t.id===o);return-1!==i&&(this._favorites[i]=Object.assign(Object.assign(Object.assign({},this._favorites[i]),t),{name:(null===(r=t.name)||void 0===r?void 0:r.trim())||this._favorites[i].name}),this._saveToStorage(),this._notifyListeners(),this._broadcastChange(),this._syncToHAIfAvailable(),!0)}deleteFavorite(o){const t=this._favorites.findIndex(t=>t.id===o);return-1!==t&&(this._favorites[t],this._favorites.splice(t,1),this._saveToStorage(),this._notifyListeners(),this._broadcastChange(),this._syncToHAIfAvailable(),!0)}reorderFavorites(o){const t=new Set(this._favorites.map(o=>o.id));return!(!o.every(o=>t.has(o))||o.length!==this._favorites.length||(o.forEach((o,t)=>{const r=this._favorites.find(t=>t.id===o);r&&(r.order=t)}),this._saveToStorage(),this._notifyListeners(),this._broadcastChange(),this._syncToHAIfAvailable(),0))}importFromConfig(o){if(!Array.isArray(o)||0===o.length)return;const t=new Set(this._favorites.map(o=>o.color.toLowerCase()));o.forEach(o=>{var r,i;!t.has(o.color.toLowerCase())&&this._isValidColor(o.color)&&this._favorites.push({id:o.id||this._generateId(),name:(null===(r=o.name)||void 0===r?void 0:r.trim())||"Unnamed Color",color:o.color,order:null!==(i=o.order)&&void 0!==i?i:this._getNextOrder()})}),this._saveToStorage(),this._notifyListeners(),this._broadcastChange(),this._syncToHAIfAvailable()}exportForConfig(){return this.getFavorites()}hasColor(o){return this._favorites.some(t=>t.color.toLowerCase()===o.toLowerCase())}refreshFromStorage(){this._loadFromStorage(),this._notifyListeners()}setHass(o){if(this._hass=null!=o?o:null,!this._haLoaded&&(null==o?void 0:o.callApi))return!1===this._isIntegrationInstalled(o)?(this._integrationMissing=!0,this._haLoaded=!0,void this._logMissingIntegrationOnce()):void this.loadFromHA(o).catch(()=>{})}_isIntegrationInstalled(o){var t;const r=null===(t=null==o?void 0:o.config)||void 0===t?void 0:t.components;if(Array.isArray(r))return r.includes("ultra_card_pro_cloud")}_logMissingIntegrationOnce(){this._logged404||(this._logged404=!0,console.info('Ultra Card: Favorite colors sync requires the "Ultra Card Pro Cloud" integration. Install it from HACS (Integration: Ultra Card Pro Cloud) to persist colors across devices and after logout.'))}async loadFromHA(o){if((null==o?void 0:o.callApi)&&!this._integrationMissing)return this._loadPromise||(this._loadPromise=this._doLoadFromHA(o).finally(()=>{this._loadPromise=null})),this._loadPromise}async _doLoadFromHA(o){var t,r,i;try{const t=await o.callApi("GET","ultra_card_pro_cloud/favorite_colors");this._haLoaded=!0;const r=null==t?void 0:t.colors;if(Array.isArray(r)&&r.length>0){const o=r.filter(o=>this._isValidFavorite(o));o.length>0&&(this._favorites=o,this._saveToStorage(),this._notifyListeners(),this._broadcastChange())}}catch(o){const e=null!==(r=null!==(t=null==o?void 0:o.status)&&void 0!==t?t:null==o?void 0:o.status_code)&&void 0!==r?r:null===(i=null==o?void 0:o.response)||void 0===i?void 0:i.status;if(404===e)return this._haLoaded=!0,this._integrationMissing=!0,void this._logMissingIntegrationOnce();if(401===e||403===e)return this._haLoaded=!0,void console.debug("Failed to load favorite colors from HA (auth error):",o);console.debug("Failed to load favorite colors from HA (will retry):",o)}}async syncToHA(o){var t,r,i;if(null==o?void 0:o.callApi)if(this._integrationMissing||!1===this._isIntegrationInstalled(o))this._integrationMissing=!0;else try{await o.callApi("POST","ultra_card_pro_cloud/favorite_colors",{colors:this._favorites})}catch(o){if(404===(null!==(r=null!==(t=null==o?void 0:o.status)&&void 0!==t?t:null==o?void 0:o.status_code)&&void 0!==r?r:null===(i=null==o?void 0:o.response)||void 0===i?void 0:i.status))return this._integrationMissing=!0,void this._logMissingIntegrationOnce();console.debug("Failed to sync favorite colors to HA:",o)}}_syncToHAIfAvailable(){var o;(null===(o=this._hass)||void 0===o?void 0:o.callApi)&&this.syncToHA(this._hass).catch(()=>{})}subscribe(o){this._listeners.add(o);const t=this.getFavorites();return o(t),()=>{this._listeners.delete(o)}}clearAll(){this._favorites=[],this._saveToStorage(),this._notifyListeners(),this._broadcastChange(),this._syncToHAIfAvailable()}testService(){console.log("UcFavoriteColorsService: Test method called"),console.log("Current favorites:",this._favorites),console.log("Number of listeners:",this._listeners.size);const o=this.addFavorite("Test Color","#ff0000");console.log("Test color added:",o);const t=this.getFavorites();console.log("All favorites after test add:",t)}debugFavoriteColors(){console.log("=== Ultra Card Favorite Colors Debug Info ==="),console.log("Storage Key:",a.STORAGE_KEY),console.log("Current Favorite Colors Count:",this._favorites.length),console.log("Listeners Count:",this._listeners.size),console.log("LocalStorage Available:",this._isLocalStorageAvailable());try{const o=(0,s.bi)(a.STORAGE_KEY);if(console.log("Raw Storage Data:",o?`${o.length} characters`:"null"),console.log("Storage Data Valid:",o?"Valid JSON":"No data"),o){const t=JSON.parse(o);console.log("Parsed Data Type:",Array.isArray(t)?"Array":typeof t),console.log("Parsed Data Length:",Array.isArray(t)?t.length:"N/A")}}catch(o){console.error("Storage Data Error:",o)}console.log("Favorite Colors List:",this._favorites.map(o=>({id:o.id,name:o.name,color:o.color,order:o.order}))),console.log("==========================================")}_loadFromStorage(){try{if(!this._isLocalStorageAvailable())return void(this._favorites=[]);const o=(0,s.bi)(a.STORAGE_KEY);if(o){const t=JSON.parse(o);Array.isArray(t)?this._favorites=t.filter(this._isValidFavorite.bind(this)):this._favorites=[]}else this._favorites=[]}catch(o){console.error("Failed to load favorite colors from storage:",o),this._favorites=[]}}_saveToStorage(){try{if(!this._isLocalStorageAvailable())return;const o=JSON.stringify(this._favorites);(0,s.FX)(a.STORAGE_KEY,o)}catch(o){console.error("Failed to save favorite colors to storage:",o),o instanceof DOMException&&o.code===DOMException.QUOTA_EXCEEDED_ERR?(console.error("localStorage quota exceeded! Consider clearing old data or using fewer favorite colors."),this._handleStorageQuotaExceeded()):console.error("Unknown storage error:",o)}}_setupStorageListener(){window.addEventListener("storage",o=>{o.key===a.STORAGE_KEY&&(this._loadFromStorage(),this._notifyListeners())}),window.addEventListener(a.SYNC_EVENT,o=>{var t;(null===(t=o.detail)||void 0===t?void 0:t.sourceInstance)===this._instanceId||this._isBroadcasting||(this._loadFromStorage(),this._notifyListeners())})}_broadcastChange(){this._isBroadcasting=!0,window.dispatchEvent(new CustomEvent(a.SYNC_EVENT,{detail:{sourceInstance:this._instanceId}})),setTimeout(()=>{this._isBroadcasting=!1},0)}_notifyListeners(){const o=this.getFavorites();this._listeners.forEach(t=>{try{t(o)}catch(o){console.warn("Error notifying favorite colors listener:",o)}})}_generateId(){return`fav-${Date.now()}-${Math.random().toString(36).substr(2,9)}`}_getNextOrder(){return 0===this._favorites.length?0:Math.max(...this._favorites.map(o=>o.order))+1}_isValidFavorite(o){return o&&"string"==typeof o.id&&"string"==typeof o.name&&"string"==typeof o.color&&"number"==typeof o.order&&this._isValidColor(o.color)}_isValidColor(o){if(!o||"string"!=typeof o)return!1;const t=o.trim();if(0===t.length)return!1;if(t.toLowerCase().includes("gradient"))return/^(linear-gradient|radial-gradient|conic-gradient|repeating-linear-gradient|repeating-radial-gradient)\s*\(.*\)\s*$/i.test(t);if(t.startsWith("var("))return t.includes("--")&&t.endsWith(")");if([/^#([A-Fa-f0-9]{3,8})$/,/^rgb\s*\(/i,/^rgba\s*\(/i,/^hsl\s*\(/i,/^hsla\s*\(/i,/^hwb\s*\(/i,/^lab\s*\(/i,/^lch\s*\(/i,/^oklch\s*\(/i,/^oklab\s*\(/i,/^color\s*\(/i].some(o=>o.test(t)))return!0;const r=t.toLowerCase();return!!["transparent","currentcolor","inherit","initial","unset","red","blue","green","yellow","orange","purple","pink","brown","black","white","gray","grey","cyan","magenta","lime","navy","teal","silver","maroon","olive","aqua","fuchsia","coral","crimson","gold","indigo","ivory","khaki","lavender","plum","salmon","sienna","tan","tomato","turquoise","violet","wheat"].includes(r)||!!/^[a-zA-Z][a-zA-Z0-9-]*$/.test(t)}_isLocalStorageAvailable(){try{const o="__ultra_card_colors_storage_test__";return(0,s.FX)(o,"test"),(0,s.Pw)(o),!0}catch(o){return!1}}_handleStorageQuotaExceeded(){if(console.log("Attempting to free up storage space by removing oldest favorite colors..."),this._favorites.length<=1)return void console.error("Cannot free up space - only one or no favorite colors exist");const o=Math.max(1,Math.floor(.25*this._favorites.length)),t=[...this._favorites].sort((o,t)=>o.order-t.order).slice(0,this._favorites.length-o);this._favorites=t,console.log(`Removed ${o} oldest favorite colors to free up storage space`);try{const o=JSON.stringify(this._favorites);(0,s.FX)(a.STORAGE_KEY,o),console.log("Successfully saved favorite colors after cleanup"),this._notifyListeners(),this._broadcastChange()}catch(o){console.error("Still cannot save after cleanup:",o)}}}a.STORAGE_KEY="ultra-card-favorite-colors",a.SYNC_EVENT="ultra-card-favorite-colors-changed";const n=new a;"undefined"!=typeof window&&(window.ucFavoriteColorsService=n,window.debugUltraCardFavoriteColors=()=>n.debugFavoriteColors());var l=r(9978),c=r(378),d=r(7568),h=r(821),p=function(o,t,r,i){var e,s=arguments.length,a=s<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(o,t,r,i);else for(var n=o.length-1;n>=0;n--)(e=o[n])&&(a=(s<3?e(a):s>3?e(t,r,a):e(t,r))||a);return s>3&&a&&Object.defineProperty(t,r,a),a};let g=class extends i.WF{constructor(){super(...arguments),this._colors=[],this._toastMsg="",this._showAddForm=!1,this._newColorName="",this._newColorValue="#3498db",this._editingId=null,this._editName="",this._editColor="",this._cloudUser=null,this._syncStatus=null,this._syncing=!1}connectedCallback(){super.connectedCallback(),n.refreshFromStorage(),this.hass&&n.setHass(this.hass),this._colors=n.getFavorites(),this._unsub=n.subscribe(o=>{this._colors=o}),this._cloudUser=c.x.getCurrentUser(),this._syncStatus=d.Q.getSyncStatus(),this._authUnsub=o=>{this._cloudUser=o},c.x.addListener(this._authUnsub),this._syncUnsub=o=>{this._syncStatus=o},d.Q.addListener(this._syncUnsub)}updated(o){o.has("hass")&&this.hass&&n.setHass(this.hass)}disconnectedCallback(){var o;super.disconnectedCallback(),null===(o=this._unsub)||void 0===o||o.call(this),this._authUnsub&&c.x.removeListener(this._authUnsub),this._syncUnsub&&d.Q.removeListener(this._syncUnsub),this._toastTimer&&clearTimeout(this._toastTimer)}_goToAccount(){(0,h.nL)(this,{tab:"account"})}_formatSyncTime(o){if(!o)return"Never";try{const t=new Date(o),r=Math.floor((Date.now()-t.getTime())/6e4);if(r<1)return"Just now";if(r<60)return`${r}m ago`;const i=Math.floor(r/60);return i<24?`${i}h ago`:t.toLocaleDateString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch(o){return"Unknown"}}async _syncNow(){if(!this._syncing){this._syncing=!0;try{await d.Q.syncFavoriteColors(),this._showToast("Colors synced ✓")}catch(o){this._showToast("Sync failed — try again")}finally{this._syncing=!1}}}_renderSyncBanner(){var o;return this._cloudUser?i.qy`
    ...
    `:i.qy`
      ...
      `}_showToast(o){this._toastMsg=o,this._toastTimer&&clearTimeout(this._toastTimer),this._toastTimer=setTimeout(()=>this._toastMsg="",2e3)}_copyColor(o){try{navigator.clipboard.writeText(o),this._showToast(`Copied ${o}`)}catch(o){}}_deleteColor(o){n.deleteFavorite(o.id),this._colors=n.getFavorites()}_addColor(){const o=this._newColorName.trim(),t=this._newColorValue.trim();o&&t&&(n.hasColor(t)?this._showToast("This color already exists"):(n.addFavorite(o,t),this._colors=n.getFavorites(),this._newColorName="",this._newColorValue="#3498db",this._showAddForm=!1,this._showToast(`Added "${o}"`)))}_startEdit(o){this._editingId=o.id,this._editName=o.name,this._editColor=o.color}_saveEdit(){this._editingId&&(n.updateFavorite(this._editingId,{name:this._editName,color:this._editColor}),this._colors=n.getFavorites(),this._editingId=null,this._showToast("Color updated"))}_cancelEdit(){this._editingId=null}_isLight(o){try{const t=o.replace("#","");if(t.length<6)return!0;const r=parseInt(t.substring(0,2),16);return(299*r+587*parseInt(t.substring(2,4),16)+114*parseInt(t.substring(4,6),16))/1e3>155}catch(o){return!1}}render(){if(0===this._colors.length&&!this._showAddForm)return i.qy`
      ...
      `;const o=this._newColorValue&&n.hasColor(this._newColorValue);return i.qy`
      <div class="hub-tab-blurb">
        <ha-icon icon="mdi:information-outline"></ha-icon>
        <p><strong>Favorite colors</strong> appear in every Ultra Card color picker so you can reuse your palette. Add colors here or save them from any picker with the heart icon.</p>
      </div>
    ...
    `],p([(0,e.MZ)({attribute:!1})],g.prototype,"hass",void 0),p([(0,e.wk)()],g.prototype,"_colors",void 0),p([(0,e.wk)()],g.prototype,"_toastMsg",void 0),p([(0,e.wk)()],g.prototype,"_showAddForm",void 0),p([(0,e.wk)()],g.prototype,"_newColorName",void 0),p([(0,e.wk)()],g.prototype,"_newColorValue",void 0),p([(0,e.wk)()],g.prototype,"_editingId",void 0),p([(0,e.wk)()],g.prototype,"_editName",void 0),p([(0,e.wk)()],g.prototype,"_editColor",void 0),p([(0,e.wk)()],g.prototype,"_cloudUser",void 0),p([(0,e.wk)()],g.prototype,"_syncStatus",void 0),p([(0,e.wk)()],g.prototype,"_syncing",void 0),g=p([(0,e.EM)("hub-colors-tab")],g)}}]);