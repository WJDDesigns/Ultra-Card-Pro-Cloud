"use strict";(self.webpackChunkultra_card=self.webpackChunkultra_card||[]).push([[6597],{6597(e,t,a){a.r(t),a.d(t,{HubTemplatesTab:()=>l});var i=a(5183),o=a(4276),n=a(9978),s=function(e,t,a,i){var o,n=arguments.length,s=n<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,a):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,a,i);else for(var r=e.length-1;r>=0;r--)(o=e[r])&&(s=(n<3?o(s):n>3?o(t,a,s):o(t,a))||s);return n>3&&s&&Object.defineProperty(t,a,s),s};const r=[{type:"text",title:"Text Module"},{type:"info",title:"Info"},{type:"markdown",title:"Markdown"},{type:"icon",title:"Icon"},{type:"bar",title:"Bars"},{type:"graphs",title:"Graphs"},{type:"camera",title:"Camera"},{type:"spinbox",title:"Spinbox"},{type:"toggle",title:"Toggle"},{type:"dropdown",title:"Dropdown"},{type:"gauge",title:"Gauge"},{type:"display_conditions",title:"Display conditions"},{type:"layout",title:"Layout (row/column visibility)"},{type:"card",title:"Card appearance (Card Settings)"}];let l=class extends i.WF{constructor(){super(...arguments),this._copiedId=null,this._copyTimeout=null}disconnectedCallback(){super.disconnectedCallback(),this._copyTimeout&&clearTimeout(this._copyTimeout)}_copyExample(e,t){navigator.clipboard.writeText(t).then(()=>{this._copiedId=e,this._copyTimeout&&clearTimeout(this._copyTimeout),this._copyTimeout=setTimeout(()=>{this._copiedId=null,this._copyTimeout=null},2e3)})}_renderExample(e,t){const a=this._copiedId===e;return i.qy`
    ...
    `}render(){return i.qy`
      ...
      <div class="section">
        ...
        ${[{title:"Text / content (text, markdown)",description:"Return content and optional color. Simple string is also valid.",code:'{"content": "Hello {{ states(\'sensor.name\') }}", "color": "var(--primary-color)"}'},{title:"Icon / info module (name, state, icon, colors)",description:"Full set of display properties for icon and info modules.",code:'{"name": "Living Room", "state_text": "{{ states(\'sensor.temperature\') }}°", "icon": "mdi:thermometer", "icon_color": "#2196f3", "name_color": "#333", "state_color": "#666", "container_background_color": "rgba(0,0,0,0.05)"}'},{title:"Bar module (value and label)",description:"Value can be number or string; label appears beside the bar.",code:'{"value": {{ states("sensor.battery") | float(0) }}, "label": "{{ states(\'sensor.battery\') }}%"}'},{title:"Gauge color override",description:"Unified template can return gauge_color to override color mode.",code:'{"value": {{ states("sensor.level") | float(0) }}, "gauge_color": "#4caf50"}'},{title:"Camera module (entity, overlay, visibility)",description:"Return camera entity ID, overlay text/color, and visible boolean.",code:'{"entity": "camera.front_door", "overlay_text": "{{ states(\'sensor.door\') }}", "overlay_color": "#fff", "visible": true}'},{title:"Simple string (icon name)",description:"Returning a plain string is valid; in icon module it is used as the icon name.",code:"mdi:lightbulb-on"},{title:"Card appearance (background, border, shadow)",description:"Enable Appearance Template Mode in Card Settings. Return a color string for background-only, or JSON with card_* keys.",code:'{% set period = states(\'sensor.day_period\') %}\n{\n  "card_background": "{% if period == \'night\' %}#1b1f3a{% else %}var(--card-background-color){% endif %}",\n  "card_border_color": "var(--divider-color)",\n  "card_border_radius": 12,\n  "card_shadow_enabled": true\n}'}].map((e,t)=>this._renderExample(`unified-${t}`,e))}
      </div>
