"use strict";(self.webpackChunkultra_card=self.webpackChunkultra_card||[]).push([[8234],{2659(e,t,o){o.d(t,{UltraLightModule:()=>u});var r=o(5183),i=o(5096),n=o(3721),s=(o(7921),o(4276)),a=o(1001),l=function(e,t,o,r){var i,n=arguments.length,s=n<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,o):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,o,r);else for(var a=e.length-1;a>=0;a--)(i=e[a])&&(s=(n<3?i(s):n>3?i(t,o,s):i(t,o))||s);return n>3&&s&&Object.defineProperty(t,o,s),s};class c{static rgbToHs(e,t,o){e/=255,t/=255,o/=255;const r=Math.max(e,t,o),i=Math.min(e,t,o);let n=0;const s=0===r?0:(r-i)/r;if(r!==i){switch(r){case e:n=(t-o)/(r-i)+(t<o?6:0);break;case t:n=(o-e)/(r-i)+2;break;case o:n=(e-t)/(r-i)+4}n/=6}return[Math.round(360*n),Math.round(100*s)]}static hsToRgb(e,t){e/=360,t/=100;const o=Math.floor(6*e),r=6*e-o,i=1*(1-t),n=1*(1-r*t),s=1*(1-(1-r)*t);let a,l,c;switch(o%6){case 0:[a,l,c]=[1,s,i];break;case 1:[a,l,c]=[n,1,i];break;case 2:[a,l,c]=[i,1,s];break;case 3:[a,l,c]=[i,n,1];break;case 4:[a,l,c]=[s,i,1];break;case 5:[a,l,c]=[1,i,n];break;default:[a,l,c]=[0,0,0]}return[Math.round(255*a),Math.round(255*l),Math.round(255*c)]}static rgbToXy(e,t,o){t/=255,o/=255;const r=.4124*(e=(e/=255)>.04045?Math.pow((e+.055)/1.055,2.4):e/12.92)+.3576*(t=t>.04045?Math.pow((t+.055)/1.055,2.4):t/12.92)+.1805*(o=o>.04045?Math.pow((o+.055)/1.055,2.4):o/12.92),i=.2126*e+.7152*t+.0722*o,n=r+i+(.0193*e+.1192*t+.9505*o);return 0===n?[.3127,.329]:[Math.round(r/n*1e4)/1e4,Math.round(i/n*1e4)/1e4]}static xyToRgb(e,t,o=1){const r=o/t*e,i=o/t*(1-e-t);let n=3.2406*r+-1.5372*o+-.4986*i,s=-.9689*r+1.8758*o+.0415*i,a=.0557*r+-.204*o+1.057*i;return n=n<=.0031308?12.92*n:1.055*Math.pow(n,1/2.4)-.055,s=s<=.0031308?12.92*s:1.055*Math.pow(s,1/2.4)-.055,a=a<=.0031308?12.92*a:1.055*Math.pow(a,1/2.4)-.055,n=Math.max(0,Math.min(1,n)),s=Math.max(0,Math.min(1,s)),a=Math.max(0,Math.min(1,a)),[Math.round(255*n),Math.round(255*s),Math.round(255*a)]}static rgbToHex(e,t,o){return"#"+[e,t,o].map(e=>{const t=e.toString(16);return 1===t.length?"0"+t:t}).join("")}static hexToRgb(e){const t=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(e);return t?[parseInt(t[1],16),parseInt(t[2],16),parseInt(t[3],16)]:null}static kelvinToMired(e){return Math.round(1e6/e)}static miredToKelvin(e){return Math.round(1e6/e)}static miredToRgb(e){const t=this.miredToKelvin(e);return this.kelvinToRgb(t)}static kelvinToRgb(e){let t,o,r;const i=e/100;return i<=66?t=255:(t=i-60,t=329.698727446*Math.pow(t,-.1332047592),t=Math.max(0,Math.min(255,t))),i<=66?(o=i,o=99.4708025861*Math.log(o)-161.1195681661):(o=i-60,o=288.1221695283*Math.pow(o,-.0755148492)),o=Math.max(0,Math.min(255,o)),i>=66?r=255:i<=19?r=0:(r=i-10,r=138.5177312231*Math.log(r)-305.0447927307,r=Math.max(0,Math.min(255,r))),[Math.round(t),Math.round(o),Math.round(r)]}}let d=class extends r.WF{constructor(){super(...arguments),this.mode="hs",this.min_mireds=153,this.max_mireds=500,this.disabled=!1,this.rgbww_mode=!1,this.enable_color=!0,this.enable_color_temp=!0,this._isDragging=!1,this._currentRgb=[255,255,255],this._currentHs=[0,0],this._currentXy=[.3127,.329],this._currentColorTemp=333,this._ignoringNextEffectChange=!1,this._processingEffectChange=!1,this._effectDropdownOpen=!1,this._effectSearchTerm="",this._filteredEffects=[],this._focusedInput=null,this._lastChangedMode=null,this.handleClickOutside=e=>{var t;const o=e.composedPath(),r=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector(".custom-select-container");r&&!o.includes(r)&&(this._effectDropdownOpen=!1,this._effectSearchTerm="",this.requestUpdate())}}firstUpdated(){this.updateCurrentValues(),document.addEventListener("click",this.handleClickOutside)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this.handleClickOutside)}updated(e){(e.has("rgb_color")||e.has("hs_color")||e.has("xy_color")||e.has("color_temp"))&&this.updateCurrentValues(),(e.has("enable_color")||e.has("enable_color_temp"))&&(this.enable_color||"hs"!==this.mode&&"rgb"!==this.mode&&"xy"!==this.mode||(this.enable_color_temp&&!this.rgbww_mode?this.mode="color_temp":this.mode="effect"),this.enable_color_temp||"color_temp"!==this.mode||this.rgbww_mode||(this.enable_color?this.mode="hs":this.mode="effect"))}updateCurrentValues(){const e="xy"===this._lastChangedMode&&("xy-x"===this._focusedInput||"xy-y"===this._focusedInput),t="hs"===this._lastChangedMode&&("hs-hue"===this._focusedInput||"hs-sat"===this._focusedInput);this.rgb_color?(this._currentRgb=[...this.rgb_color],t||(this._currentHs=c.rgbToHs(this.rgb_color[0],this.rgb_color[1],this.rgb_color[2])),e||(this._currentXy=c.rgbToXy(this.rgb_color[0],this.rgb_color[1],this.rgb_color[2]))):this.hs_color?(t||(this._currentHs=[...this.hs_color]),this._currentRgb=c.hsToRgb(this._currentHs[0],this._currentHs[1]),e||(this._currentXy=c.rgbToXy(this._currentRgb[0],this._currentRgb[1],this._currentRgb[2]))):this.xy_color?(e||(this._currentXy=[...this.xy_color]),this._currentRgb=c.xyToRgb(this._currentXy[0],this._currentXy[1]),t||(this._currentHs=c.rgbToHs(this._currentRgb[0],this._currentRgb[1],this._currentRgb[2]))):this.color_temp&&(this._currentRgb=c.miredToRgb(this.color_temp),t||(this._currentHs=c.rgbToHs(this._currentRgb[0],this._currentRgb[1],this._currentRgb[2])),e||(this._currentXy=c.rgbToXy(this._currentRgb[0],this._currentRgb[1],this._currentRgb[2]))),this.color_temp&&(this._currentColorTemp=this.color_temp),this.enable_color||(this._currentRgb=[255,255,255],this._currentHs=[0,0],this._currentXy=[.3127,.329])}fireColorChanged(e){let t=this.mode;!this.rgbww_mode||"hs"!==this.mode&&"rgb"!==this.mode&&"xy"!==this.mode||(t="rgbww");const o={mode:t,rgbww_mode:this.rgbww_mode};"effect"===t?o.effect=this.effect:"rgbww"===t?(this.enable_color?(o.rgb_color=this._currentRgb,o.hs_color=this._currentHs,o.xy_color=this._currentXy):(o.rgb_color=[255,255,255],o.hs_color=[0,0],o.xy_color=[.3127,.329]),this.enable_color_temp&&(o.color_temp=this._currentColorTemp),o.effect=""):"color_temp"===t?(this.enable_color_temp&&(o.color_temp=this._currentColorTemp),this.enable_color||(o.rgb_color=[255,255,255],o.hs_color=[0,0],o.xy_color=[.3127,.329]),o.effect=""):"hs"!==t&&"rgb"!==t&&"xy"!==t||(this.enable_color?(o.rgb_color=this._currentRgb,o.hs_color=this._currentHs,o.xy_color=this._currentXy):(o.rgb_color=[255,255,255],o.hs_color=[0,0],o.xy_color=[.3127,.329]),this.enable_color_temp&&this.rgbww_mode&&(o.color_temp=this._currentColorTemp),o.effect=""),Object.assign(o,e),this.enable_color||o.rgb_color?!this.enable_color&&o.rgb_color&&(o.rgb_color=[255,255,255],o.hs_color=[0,0],o.xy_color=[.3127,.329]):"color_temp"===t||this.enable_color_temp&&!this.enable_color?(o.rgb_color=[255,255,255],o.hs_color=[0,0],o.xy_color=[.3127,.329]):(delete o.rgb_color,delete o.hs_color,delete o.xy_color),this.enable_color_temp||delete o.color_temp;const r=new CustomEvent("color-changed",{detail:o});this.dispatchEvent(r)}handleUltraColorPickerChange(e){if(this.disabled||!this.enable_color)return;const t=e.detail.value;if(t.startsWith("rgba")||t.startsWith("rgb")){const e=t.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?\)/);if(e){const t=parseInt(e[1]),o=parseInt(e[2]),r=parseInt(e[3]);this._currentRgb=[t,o,r],this._currentHs=c.rgbToHs(t,o,r),this._currentXy=c.rgbToXy(t,o,r),this.fireColorChanged({rgb_color:this._currentRgb,hs_color:this._currentHs,xy_color:this._currentXy,mode:"rgb"})}}else this.handleHexChange(t)}handleTestPreset(){const e=new CustomEvent("test-preset",{detail:{mode:this.mode,rgb_color:this.rgb_color,hs_color:this.hs_color,xy_color:this.xy_color,color_temp:this.color_temp,effect:this.effect},bubbles:!0,composed:!0});this.dispatchEvent(e)}handleColorWheelClick(e){if(this.disabled||!this.enable_color)return;const t=e.currentTarget.getBoundingClientRect(),o=t.width/2,r=t.height/2,i=e.clientX-t.left-o,n=e.clientY-t.top-r,s=Math.sqrt(i*i+n*n),a=Math.min(t.width,t.height)/2-3,l=Math.min(s,a);let d=Math.atan2(n,i)*(180/Math.PI);d+=90,d<0&&(d+=360),d>=360&&(d-=360);const p=100*Math.min(l/a,1);this._currentHs=[Math.round(d),Math.round(p)],this._currentRgb=c.hsToRgb(d,p),this._currentXy=c.rgbToXy(this._currentRgb[0],this._currentRgb[1],this._currentRgb[2]),this.fireColorChanged({rgb_color:this._currentRgb,hs_color:this._currentHs,xy_color:this._currentXy,mode:"hs"})}handleRgbChange(e,t){if(this.disabled||!this.enable_color)return;const o=[...this._currentRgb];o[e]=Math.max(0,Math.min(255,t)),this._currentRgb=o,this._currentHs=c.rgbToHs(o[0],o[1],o[2]),this._currentXy=c.rgbToXy(o[0],o[1],o[2]),this.fireColorChanged({rgb_color:this._currentRgb,hs_color:this._currentHs,xy_color:this._currentXy,mode:"rgb"})}handleHexChange(e){if(this.disabled||!this.enable_color)return;const t=c.hexToRgb(e);t&&(this._currentRgb=t,this._currentHs=c.rgbToHs(t[0],t[1],t[2]),this._currentXy=c.rgbToXy(t[0],t[1],t[2]),this.fireColorChanged({rgb_color:this._currentRgb,hs_color:this._currentHs,xy_color:this._currentXy,mode:"rgb"}))}handleHsChange(e,t){if(this.disabled||!this.enable_color)return;const o=[...this._currentHs];0===e?o[0]=Math.max(0,Math.min(360,t)):o[1]=Math.max(0,Math.min(100,t)),this._currentHs=o,this._currentRgb=c.hsToRgb(o[0],o[1]),this._currentXy=c.rgbToXy(this._currentRgb[0],this._currentRgb[1],this._currentRgb[2]),this._lastChangedMode="hs",this.fireColorChanged({rgb_color:this._currentRgb,hs_color:this._currentHs,xy_color:this._currentXy,mode:"hs"})}handleXyChange(e,t){if(this.disabled||!this.enable_color)return;const o=[...this._currentXy];o[e]=Math.max(0,Math.min(1,t)),this._currentXy=o,this._currentRgb=c.xyToRgb(o[0],o[1]),this._currentHs=c.rgbToHs(this._currentRgb[0],this._currentRgb[1],this._currentRgb[2]),this._lastChangedMode="xy",this.fireColorChanged({rgb_color:this._currentRgb,hs_color:this._currentHs,xy_color:this._currentXy,mode:"xy"})}handleColorTempChange(e){!this.disabled&&this.enable_color_temp&&(this._currentColorTemp=Math.max(this.min_mireds,Math.min(this.max_mireds,e)),this.rgbww_mode?this.fireColorChanged({rgb_color:this._currentRgb,hs_color:this._currentHs,xy_color:this._currentXy,color_temp:this._currentColorTemp,mode:"rgbww"}):this.fireColorChanged({color_temp:this._currentColorTemp,mode:"color_temp"}))}handleEffectsTabClick(){this.disabled||(this.mode="effect",this.requestUpdate())}handleEffectSelectionSimple(e){this.disabled||(this._effectDropdownOpen=!1,this._effectSearchTerm="",this.effect=e,e&&""!==e.trim()?(this.mode="effect",this.fireColorChanged({effect:e,mode:"effect"})):(this.mode="hs",this.fireColorChanged({effect:"",mode:"hs"})))}updateFilteredEffects(){const e=this._effectSearchTerm.toLowerCase();this._filteredEffects=(this.effect_list||[]).filter(t=>t.toLowerCase().includes(e))}handleEffectSearch(e){const t=e.target;this._effectSearchTerm=t.value,this.updateFilteredEffects()}toggleEffectDropdown(){this.disabled||(this._effectDropdownOpen=!this._effectDropdownOpen,this._effectDropdownOpen&&(this.updateFilteredEffects(),setTimeout(()=>{var e;const t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector(".effect-search");t&&t.focus()},100)),this.requestUpdate())}handleEffectChange(e){if(!this.disabled)if(this._ignoringNextEffectChange)this._ignoringNextEffectChange=!1;else if(!this._processingEffectChange){this._processingEffectChange=!0;try{const t=e||"";this.effect=t,t&&""!==t.trim()?this.fireColorChanged({effect:t,mode:"effect"}):this.fireColorChanged({effect:"",mode:"hs"})}catch(e){console.error("🎬 Error in handleEffectChange:",e)}finally{this._processingEffectChange=!1}}}getColorWheelPickerPosition(){const[e,t]=this._currentHs,o=(e-90)*Math.PI/180,r=t/100*45;return{x:50+Math.cos(o)*r,y:50+Math.sin(o)*r}}render(){const e=this.getColorWheelPickerPosition(),t=c.rgbToHex(this._currentRgb[0],this._currentRgb[1],this._currentRgb[2]),o=c.miredToKelvin(this._currentColorTemp);return r.qy`
                    ...
                    <div class="hs-inputs">
                      <div class="hs-input-group">
                        ...
                        <input
                          ...
                          @paste=${e=>{var t;e.preventDefault();const o=(null===(t=e.clipboardData)||void 0===t?void 0:t.getData("text"))||"",r=parseFloat(o)||0,i=Math.max(0,Math.min(360,r));e.target.value=i.toString(),this.handleHsChange(0,i)}}
                      ...
                      <div class="hs-input-group">
                        ...
                        <input
                          ...
                          @paste=${e=>{var t;e.preventDefault();const o=(null===(t=e.clipboardData)||void 0===t?void 0:t.getData("text"))||"",r=parseFloat(o)||0,i=Math.max(0,Math.min(100,r));e.target.value=i.toString(),this.handleHsChange(1,i)}}
                          @keydown=${e=>{const t=e.key>="0"&&e.key<="9"||"-"===e.key||"."===e.key;["Backspace","Delete","ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Tab","Enter","Home","End"].includes(e.key)||t||e.ctrlKey||e.metaKey||e.preventDefault()}}
                        />
                        <span class="unit">%</span>
                      </div>
                    ...
                    <div class="xy-inputs">
                      <div class="xy-input-group">
                        ...
                        <input
                          ...
                          @blur=${()=>{this._focusedInput=null,setTimeout(()=>{this._lastChangedMode=null},100)}}
                          @input=${e=>{}}
                          @change=${e=>{const t=e.target,o=parseFloat(t.value)||0,r=Math.max(0,Math.min(1,o)),i=r.toFixed(4).replace(/\.?0+$/,"");t.value=i,this.handleXyChange(0,r)}}
                          @paste=${e=>{var t;e.preventDefault();const o=(null===(t=e.clipboardData)||void 0===t?void 0:t.getData("text"))||"",r=parseFloat(o)||0,i=Math.max(0,Math.min(1,r)),n=e.target,s=i.toFixed(4).replace(/\.?0+$/,"");n.value=s,this.handleXyChange(0,i)}}
                          @keydown=${e=>{const t=e.key>="0"&&e.key<="9"||"-"===e.key||"."===e.key;["Backspace","Delete","ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Tab","Enter","Home","End"].includes(e.key)||t||e.ctrlKey||e.metaKey||e.preventDefault()}}
                        />
                      </div>
                      <div class="xy-input-group">
                        ...
                        <input
                          ...
                          @blur=${()=>{this._focusedInput=null,setTimeout(()=>{this._lastChangedMode=null},100)}}
                          @input=${e=>{}}
                          @change=${e=>{const t=e.target,o=parseFloat(t.value)||0,r=Math.max(0,Math.min(1,o)),i=r.toFixed(4).replace(/\.?0+$/,"");t.value=i,this.handleXyChange(1,r)}}
                          @paste=${e=>{var t;e.preventDefault();const o=(null===(t=e.clipboardData)||void 0===t?void 0:t.getData("text"))||"",r=parseFloat(o)||0,i=Math.max(0,Math.min(1,r)),n=e.target,s=i.toFixed(4).replace(/\.?0+$/,"");n.value=s,this.handleXyChange(1,i)}}
                          @keydown=${e=>{const t=e.key>="0"&&e.key<="9"||"-"===e.key||"."===e.key;["Backspace","Delete","ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Tab","Enter","Home","End"].includes(e.key)||t||e.ctrlKey||e.metaKey||e.preventDefault()}}
                        />
                      </div>
                    </div>
    ...
    `}static get styles(){return r.AH`
      ...
      .custom-dropdown-menu {
        ...
        z-index: ${a.Mu.DROPDOWN_MENU} !important;
        max-height: 300px;
        overflow: hidden;
      }
    ...
    `}};l([(0,s.MZ)({attribute:!1})],d.prototype,"hass",void 0),l([(0,s.MZ)()],d.prototype,"rgb_color",void 0),l([(0,s.MZ)()],d.prototype,"hs_color",void 0),l([(0,s.MZ)()],d.prototype,"xy_color",void 0),l([(0,s.MZ)()],d.prototype,"color_temp",void 0),l([(0,s.MZ)()],d.prototype,"effect",void 0),l([(0,s.MZ)()],d.prototype,"effect_speed",void 0),l([(0,s.MZ)()],d.prototype,"effect_intensity",void 0),l([(0,s.MZ)()],d.prototype,"effect_reverse",void 0),l([(0,s.MZ)()],d.prototype,"effect_list",void 0),l([(0,s.MZ)()],d.prototype,"mode",void 0),l([(0,s.MZ)()],d.prototype,"min_mireds",void 0),l([(0,s.MZ)()],d.prototype,"max_mireds",void 0),l([(0,s.MZ)({type:Boolean})],d.prototype,"disabled",void 0),l([(0,s.MZ)({type:Boolean})],d.prototype,"rgbww_mode",void 0),l([(0,s.MZ)({type:Boolean})],d.prototype,"enable_color",void 0),l([(0,s.MZ)({type:Boolean})],d.prototype,"enable_color_temp",void 0),l([(0,s.wk)()],d.prototype,"_isDragging",void 0),l([(0,s.wk)()],d.prototype,"_currentRgb",void 0),l([(0,s.wk)()],d.prototype,"_currentHs",void 0),l([(0,s.wk)()],d.prototype,"_currentXy",void 0),l([(0,s.wk)()],d.prototype,"_currentColorTemp",void 0),l([(0,s.wk)()],d.prototype,"_ignoringNextEffectChange",void 0),l([(0,s.wk)()],d.prototype,"_processingEffectChange",void 0),l([(0,s.wk)()],d.prototype,"_effectDropdownOpen",void 0),l([(0,s.wk)()],d.prototype,"_effectSearchTerm",void 0),l([(0,s.wk)()],d.prototype,"_filteredEffects",void 0),l([(0,s.wk)()],d.prototype,"_focusedInput",void 0),l([(0,s.wk)()],d.prototype,"_lastChangedMode",void 0),d=l([(0,s.EM)("uc-light-color-picker")],d);var p=o(4865),h=o(2063);class g{static rgbToHex(e,t,o){return"#"+[e,t,o].map(e=>{const t=e.toString(16);return 1===t.length?"0"+t:t}).join("")}static hexToRgb(e){const t=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(e);return t?[parseInt(t[1],16),parseInt(t[2],16),parseInt(t[3],16)]:null}static rgbToHsv(e,t,o){e/=255,t/=255,o/=255;const r=Math.max(e,t,o),i=Math.min(e,t,o);let n=0;const s=r,a=r-i,l=0===r?0:a/r;if(r!==i){switch(r){case e:n=(t-o)/a+(t<o?6:0);break;case t:n=(o-e)/a+2;break;case o:n=(e-t)/a+4}n/=6}return[Math.round(360*n),Math.round(100*l),Math.round(100*s)]}static hsvToRgb(e,t,o){e/=360,t/=100,o/=100;const r=Math.floor(6*e),i=6*e-r,n=o*(1-t),s=o*(1-i*t),a=o*(1-(1-i)*t);let l,c,d;switch(r%6){case 0:[l,c,d]=[o,a,n];break;case 1:[l,c,d]=[s,o,n];break;case 2:[l,c,d]=[n,o,a];break;case 3:[l,c,d]=[n,s,o];break;case 4:[l,c,d]=[a,n,o];break;case 5:[l,c,d]=[o,n,s];break;default:[l,c,d]=[0,0,0]}return[Math.round(255*l),Math.round(255*c),Math.round(255*d)]}static rgbToXy(e,t,o){t/=255,o/=255;const r=.4124*(e=(e/=255)>.04045?Math.pow((e+.055)/1.055,2.4):e/12.92)+.3576*(t=t>.04045?Math.pow((t+.055)/1.055,2.4):t/12.92)+.1805*(o=o>.04045?Math.pow((o+.055)/1.055,2.4):o/12.92),i=.2126*e+.7152*t+.0722*o,n=r+i+(.0193*e+.1192*t+.9505*o);return 0===n?[.3127,.329]:[r/n,i/n]}static xyToRgb(e,t,o=1){const r=o/t*e,i=o/t*(1-e-t);let n=3.2406*r+-1.5372*o+-.4986*i,s=-.9689*r+1.8758*o+.0415*i,a=.0557*r+-.204*o+1.057*i;return n=n<=.0031308?12.92*n:1.055*Math.pow(n,1/2.4)-.055,s=s<=.0031308?12.92*s:1.055*Math.pow(s,1/2.4)-.055,a=a<=.0031308?12.92*a:1.055*Math.pow(a,1/2.4)-.055,n=Math.max(0,Math.min(1,n)),s=Math.max(0,Math.min(1,s)),a=Math.max(0,Math.min(1,a)),[Math.round(255*n),Math.round(255*s),Math.round(255*a)]}static kelvinToMired(e){return Math.round(1e6/e)}static miredToKelvin(e){return Math.round(1e6/e)}static calculateWwCwMix(e,t,o){const r=(Math.max(t,Math.min(o,e))-t)/(o-t);return{ww:Math.round(255*(1-r)),cw:Math.round(255*r)}}}class u extends n.m{constructor(){super(...arguments),this.metadata={type:"light",title:"Light Control",description:"Advanced light control with color, brightness, and effects",author:"WJD Designs",version:"1.0.0",icon:"mdi:lightbulb",category:"interactive",tags:["light","color","brightness","control","smart"]},this.expandedPresets=new Set,this.draggedPresetIndex=null}createDefault(e,t){return{id:e||this.generateId("light"),type:"light",presets:[{id:this.generateId("preset"),name:"My Preset",action:"turn_on",entities:[],brightness:255,rgb_color:[255,255,255],effect:"",effect_speed:128,effect_intensity:128,effect_reverse:!1,text_color:"var(--text-primary-color)",icon_color:"var(--primary-color)",button_color:"var(--primary-color)",use_light_color_for_icon:!1,use_light_color_for_button:!0,use_icon_color_for_text:!1,smart_color:!0,button_style:"filled",show_label:!0,border_radius:8,enable_color:!0,enable_color_temp:!0}],layout:"buttons",button_alignment:"center",allow_wrapping:!0,button_gap:.8,columns:3,show_labels:!0,button_style:"filled",default_transition_time:.5,tap_action:{action:"nothing"},hold_action:{action:"nothing"},double_tap_action:{action:"nothing"},display_mode:"always",display_conditions:[]}}getSupportedColorModes(e,t){const o=t.states[e];return o&&o.attributes.supported_color_modes?o.attributes.supported_color_modes:["onoff"]}hasRgbwwSupport(e,t){return!(!e||0===e.length)&&e.some(e=>{const o=t.states[e],r=(null==o?void 0:o.attributes.supported_color_modes)||[],i=r.some(e=>"rgbww"===e||"rgbcct"===e||"rgbww_color"===e),n=r.some(e=>"xy"===e||"hs"===e||"rgb"===e),s=r.includes("color_temp");return i||n&&s})}getCurrentColorMode(e,t){const o=t.states[e];return(null==o?void 0:o.attributes.color_mode)||"onoff"}getEffectList(e,t){const o=t.states[e];return(null==o?void 0:o.attributes.effect_list)||[]}findSimilarEffect(e,t){const o=e.toLowerCase(),r=t.find(e=>e.toLowerCase()===o);if(r)return r;const i=t.find(e=>{const t=e.toLowerCase();return t.includes(o)||o.includes(t)});if(i)return i;const n={colorloop:["rainbow","color_loop","colorloop"],rainbow:["colorloop","rainbow","color_loop"],strobe:["blink","flash","strobe"],blink:["strobe","flash","blink"],breathe:["fade","breathing","breathe"],fade:["breathe","breathing","fade"],solid:["static","solid","none"]}[o]||[];for(const e of n){const o=t.find(t=>t.toLowerCase().includes(e));if(o)return o}return null}getCommonSupportedEffects(e,t){if(0===e.length)return["colorloop","random"];const o=e.map(e=>this.getEffectList(e,t));if(1===o.length)return o[0];const r=o.reduce((e,t)=>e.filter(e=>t.some(t=>e.toLowerCase()===t.toLowerCase())));if(0===r.length){const e=[],t=["colorloop","color_loop","rainbow","strobe","flash","blink","fade","breathe","breathing","solid","static"];for(const r of t)for(const t of o){const i=t.find(e=>e.toLowerCase().includes(r.toLowerCase()));i&&!e.includes(i)&&o.every(e=>e.some(e=>e.toLowerCase().includes(r.toLowerCase())||e.toLowerCase()===i.toLowerCase()))&&e.push(i)}return 0===e.length?["colorloop","strobe","fade"]:e}return r}getColorTempRange(e,t){const o=t.states[e];return{min:(null==o?void 0:o.attributes.min_mireds)||153,max:(null==o?void 0:o.attributes.max_mireds)||500}}getPresetColorTempRange(e,t){const o=e.entities||[];if(0===o.length)return{min:153,max:500};let r=153,i=500;for(const e of o){const o=t.states[e];o&&(r=Math.max(r,o.attributes.min_mireds||153),i=Math.min(i,o.attributes.max_mireds||500))}return r<i?{min:r,max:i}:{min:153,max:500}}async callLightService(e,t,o,r){try{await r.callService("light",e,Object.assign({entity_id:t},o))}catch(r){console.error(`Failed to call light.${e} for ${t}:`,r),console.error("Service data was:",o);const i=new CustomEvent("hass-notification",{detail:{message:`Failed to control light ${t}: ${r}`}});document.dispatchEvent(i)}finally{this.triggerPreviewUpdate(!0)}}renderGeneralTab(e,t,o,n){var s,a,l;const c=e,d=(null===(s=null==t?void 0:t.locale)||void 0===s?void 0:s.language)||"en";return r.qy`
      ...
      <div class="general-tab">
        ...
        <div class="presets-configuration">
          ...
          >
            ${(0,i.kg)("editor.light.section_presets",d,"Light Presets")}
          </div>
          <div class="field-description" style="margin-bottom: 16px;">
            ${(0,i.kg)("editor.light.section_presets_desc",d,"Configure light presets with specific colors, brightness, and effects. Each preset can control different entities.")}
          </div>

          ${(c.presets||[]).map((e,r)=>this.renderPresetEditor(e,r,c,t,n,o))}

          <button
            class="add-preset-btn"
            @click=${()=>this.addPreset(c,n)}
          ...
          >
            ${(0,i.kg)("editor.light.add_preset",d,"+ Add New Preset")}
          </button>
        </div>
        ...
        >
          <div
            ...
            style="font-size: 18px; font-weight: 700; text-transform: uppercase; color: var(--primary-color); margin-bottom: 16px; letter-spacing: 0.5px;"
          >
            ${(0,i.kg)("editor.light.section_layout",d,"Layout Configuration")}
          </div>
          <div class="field-description" style="margin-bottom: 16px;">
          ...
          <!-- Layout Style -->
          ${this.renderFieldSection("Layout Style","Choose the overall arrangement style for preset buttons",t,{layout:c.layout||"buttons"},[this.selectField("layout",[{value:"buttons",label:"Flexible Buttons"},{value:"grid",label:"Grid Layout"}])],e=>{const t=e.detail.value.layout;t!==c.layout&&(n({layout:t}),this.triggerPreviewUpdate())})}

          <!-- Button Alignment -->
          ${this.renderFieldSection("Button Alignment","Choose how buttons are aligned within the container",t,{button_alignment:c.button_alignment||"center"},[this.selectField("button_alignment",[{value:"left",label:"Left"},{value:"center",label:"Center"},{value:"right",label:"Right"},{value:"space-between",label:"Space Between"},{value:"space-around",label:"Space Around"},{value:"space-evenly",label:"Space Evenly"}])],e=>{const t=e.detail.value.button_alignment;t!==c.button_alignment&&(n({button_alignment:t}),this.triggerPreviewUpdate())})}
          </div>
        </div>

        <!-- Allow Wrapping Toggle -->
        ${this.renderSettingsSection((0,i.kg)("editor.light.section_wrapping",d,"Button Wrapping"),(0,i.kg)("editor.light.section_wrapping_desc",d,"Control whether buttons wrap to the next line"),[{title:"Allow Button Wrapping",description:"Allow buttons to wrap to the next line when they exceed the container width",hass:t,data:{allow_wrapping:null===(a=c.allow_wrapping)||void 0===a||a},schema:[this.booleanField("allow_wrapping")],onChange:e=>{n({allow_wrapping:e.detail.value.allow_wrapping}),this.triggerPreviewUpdate()}}])}
        ...
        >
          ...
          ${this.renderSliderField("Gap Between Buttons","Set the spacing between preset buttons (in rem units)",c.button_gap||.8,.8,0,5,.1,e=>{n({button_gap:e}),this.triggerPreviewUpdate()},"rem")}
        </div>
        ${"grid"===c.layout?r.qy`
                <div
                  class="settings-section"
                ...
                >
                  ...
                  ${this.renderFieldSection("Columns","Number of columns in grid layout",t,{columns:c.columns||3},[this.selectField("columns",[{value:"1",label:"1 Column"},{value:"2",label:"2 Columns"},{value:"3",label:"3 Columns"},{value:"4",label:"4 Columns"},{value:"5",label:"5 Columns"},{value:"6",label:"6 Columns"}])],e=>{const t=Number(e.detail.value.columns);isNaN(t)||t===c.columns||(n({columns:t}),this.triggerPreviewUpdate())})}
                </div>
              `:""}
        ...
        >
          ...
          ${this.renderSliderField("Default Transition Time","Default transition time for all presets (can be overridden per preset)",null!==(l=c.default_transition_time)&&void 0!==l?l:.5,.5,0,10,.1,e=>{e!==c.default_transition_time&&(n({default_transition_time:e}),this.triggerPreviewUpdate())},"s")}
          </div>
        </div>
    ...
    `}renderOtherTab(e,t,o,n){var s,a,l;const c=e,d=(null===(s=null==t?void 0:t.locale)||void 0===s?void 0:s.language)||"en";return r.qy`
      <div class="other-tab">
        <!-- Import/Export Presets -->
        ${this.renderSettingsSection((0,i.kg)("editor.light.section_import_export",d,"Import/Export"),(0,i.kg)("editor.light.section_import_export_desc",d,"Save and share your preset configurations"),[{title:"Export Presets",description:"Export all presets as JSON for backup or sharing",hass:t,data:{export_ready:(c.presets||[]).length>0},schema:[{name:"export_ready",label:"Export Configuration",selector:{action:{text:"Export JSON"}}}],onChange:()=>this.exportPresets(c)},{title:"Import Presets",description:"Import presets from JSON configuration",hass:t,data:{import_data:""},schema:[{name:"import_data",label:"Paste JSON Configuration",selector:{text:{multiline:!0,placeholder:"Paste exported JSON here..."}}}],onChange:e=>this.importPresets(e.detail.value.import_data,c,n,t)}])}

        <!-- Advanced Options -->
        ${this.renderSettingsSection((0,i.kg)("editor.light.section_advanced",d,"Advanced Options"),(0,i.kg)("editor.light.section_advanced_desc",d,"Fine-tune module behavior"),[{title:"Confirm Actions",description:"Show confirmation dialog before applying presets",hass:t,data:{confirm_actions:null!==(a=c.confirm_actions)&&void 0!==a&&a},schema:[this.booleanField("confirm_actions")],onChange:e=>{n({confirm_actions:e.detail.value.confirm_actions}),this.triggerPreviewUpdate()}},{title:"Show Status Feedback",description:"Show visual feedback when presets are applied",hass:t,data:{show_feedback:null===(l=c.show_feedback)||void 0===l||l},schema:[this.booleanField("show_feedback")],onChange:e=>{n({show_feedback:e.detail.value.show_feedback}),this.triggerPreviewUpdate()}}])}
      </div>
    `}renderPresetEditor(e,t,o,i,n,s){const a=()=>{const e=[...o.presets||[]];e.splice(t,1),n({presets:e}),this.triggerPreviewUpdate()},l=()=>{const t=Object.assign(Object.assign({},e),{id:this.generateId("preset"),name:`${e.name} Copy`}),r=[...o.presets||[],t];n({presets:r}),this.triggerPreviewUpdate()},c=(e,t)=>{const r=[...o.presets||[]],[i]=r.splice(e,1);r.splice(t,0,i),n({presets:r}),this.triggerPreviewUpdate()};return r.qy`
      <div
        class="preset-item"
        ...
        @drop=${e=>this.handlePresetDrop(e,t,c)}
      >
        <div
          class="preset-header"
        ...
        >
          ${this.renderPresetConfiguration(e,i,r=>{const i=[...o.presets||[]];i[t]=Object.assign(Object.assign({},e),r),n({presets:i}),this.triggerPreviewUpdate()},o,s)}
        </div>
      </div>
    `}renderPresetConfiguration(e,t,o,i,n){var s,a,l,c;return r.qy`
      <!-- Action Selection -->
      ...
      <div class="field-group" style="margin-bottom: 16px;">
        ...
        <ha-textfield
          ...
          @input=${e=>{var t;const r=e.target,i=(null===(t=r.shadowRoot)||void 0===t?void 0:t.querySelector("input"))||r,n=r.value,s=i.selectionStart,a=i.selectionEnd;o({name:n}),requestAnimationFrame(()=>{i&&"number"==typeof s&&(r.value=n,i.value=n,i.setSelectionRange(s,a||s))}),setTimeout(()=>{i&&"number"==typeof s&&(r.value=n,i.value=n,i.setSelectionRange(s,a||s))},0),setTimeout(()=>{i&&"number"==typeof s&&(r.value=n,i.value=n,i.setSelectionRange(s,a||s))},10)}}
      ...
      <div class="field-group" style="margin-bottom: 16px;">
        ...
        ${"turn_off"!==(e.action||"turn_on")?r.qy`
                ...
                <div class="light-controls-section" style="margin-top: 20px; margin-bottom: 20px;">
                  ...
                  <uc-light-color-picker
                    ...
                    .min_mireds=${this.getPresetColorTempRange(e,t).min}
                    .max_mireds=${this.getPresetColorTempRange(e,t).max}
                    ...
                    @test-preset=${()=>{this.applyPreset(e,i,t,n)}}
                  ></uc-light-color-picker>
                </div>
              `:""}
        ...
        >
          ...
          ${this.renderFieldSection("Show Label","Display preset name on this button",t,{show_label:null===(l=e.show_label)||void 0===l||l},[this.booleanField("show_label")],e=>o({show_label:e.detail.value.show_label}))}
        </div>
      </div>
      ...
      ${"turn_off"!==(e.action||"turn_on")?r.qy`
              ...
              <div class="light-controls-section" style="margin-top: 20px;">
                ...
                <div class="brightness-control" style="margin-bottom: 20px;">
                  ${this.renderSliderField("Brightness","",e.brightness?Math.round(e.brightness/255*100):100,100,1,100,1,e=>o({brightness:Math.round(e/100*255)}),"%")}
                </div>
      ...
      ${"turn_off"!==(e.action||"turn_on")?r.qy`
          ...
          >
            ...
            ${this.renderFieldSection("Smart Contrast Mode","Auto-contrast text & icon (white/black) based on button background",t,{smart_color:null===(c=e.smart_color)||void 0===c||c},[this.booleanField("smart_color")],e=>o({smart_color:e.detail.value.smart_color}))}

            <!-- Use Light Color for Icon (disabled if smart contrast is on) -->
            <div style="${e.smart_color?"opacity: 0.5; pointer-events: none;":""}">
              ${this.renderFieldSection("Use Light Color for Icon","Icon color matches the preset's light color",t,{use_light_color_for_icon:e.use_light_color_for_icon||!1},[this.booleanField("use_light_color_for_icon")],t=>{e.smart_color||o({use_light_color_for_icon:t.detail.value.use_light_color_for_icon})})}
            </div>

            <!-- Use Light Color for Button (disabled if smart contrast is on) -->
            <div style="${e.smart_color?"opacity: 0.5; pointer-events: none;":""}">
              ${this.renderFieldSection("Use Light Color for Button","Button background matches the preset's light color",t,{use_light_color_for_button:e.use_light_color_for_button||!1},[this.booleanField("use_light_color_for_button")],t=>{e.smart_color||o({use_light_color_for_button:t.detail.value.use_light_color_for_button})})}
            </div>

            <!-- Use Icon Color for Text (disabled if smart contrast is on) -->
            <div style="${e.smart_color?"opacity: 0.5; pointer-events: none;":""}">
              ${this.renderFieldSection("Use Icon Color for Text","Text color matches the icon color",t,{use_icon_color_for_text:e.use_icon_color_for_text||!1},[this.booleanField("use_icon_color_for_text")],t=>{e.smart_color||o({use_icon_color_for_text:t.detail.value.use_icon_color_for_text})})}
            </div>
          </div>
        ...
        >
          ...
          ${this.renderSliderField("Transition Time (seconds)","Override default transition time for this preset",e.transition_time||i.default_transition_time||.5,i.default_transition_time||.5,0,10,.1,e=>o({transition_time:e}),"s")}
        </div>
    ...
    `}handlePresetDragStart(e,t){this.draggedPresetIndex=t,e.dataTransfer&&(e.dataTransfer.effectAllowed="move",e.dataTransfer.setData("text/plain",t.toString()));const o=e.target.closest(".preset-item");o&&o.classList.add("dragging")}handlePresetDragOver(e){e.preventDefault(),e.dataTransfer&&(e.dataTransfer.dropEffect="move")}handlePresetDragEnter(e){e.preventDefault();const t=e.currentTarget;t&&!t.classList.contains("dragging")&&(t.style.borderTop="3px solid var(--primary-color)",t.style.backgroundColor="rgba(var(--rgb-primary-color), 0.1)")}handlePresetDragLeave(e){const t=e.currentTarget;t&&(t.style.borderTop="",t.style.backgroundColor="")}handlePresetDrop(e,t,o){e.preventDefault();const r=e.currentTarget;r.style.borderTop="",r.style.backgroundColor="",null!==this.draggedPresetIndex&&this.draggedPresetIndex!==t&&o(this.draggedPresetIndex,t),document.querySelectorAll(".preset-item").forEach(e=>{e.style.borderTop="",e.style.backgroundColor="",e.classList.remove("dragging")}),this.draggedPresetIndex=null}handlePresetDragEnd(e){var t;const o=null===(t=e.target)||void 0===t?void 0:t.closest(".preset-item");o&&o.classList.remove("dragging"),document.querySelectorAll(".preset-item").forEach(e=>{e.style.borderTop=""}),this.draggedPresetIndex=null}togglePresetHeader(e){const t=e.currentTarget.closest(".preset-item");if(!t)return;const o=t.getAttribute("data-preset-id")||"";if(!o)return;const r=t.querySelector(".preset-content"),i=t.querySelector(".expand-caret");this.expandedPresets.has(o)?this.expandedPresets.delete(o):this.expandedPresets.add(o),r&&i&&(this.expandedPresets.has(o)?(r.style.display="block",i.style.transform="rotate(180deg)"):(r.style.display="none",i.style.transform="rotate(0deg)"))}togglePresetExpanded(e){const t=document.querySelector(`[data-preset-id="${e}"]`);if(t){const o=t.querySelector(".preset-content"),r=t.querySelector(".expand-caret");o&&r&&(this.expandedPresets.has(e)?(this.expandedPresets.delete(e),o.style.display="none",r.style.transform="rotate(0deg)"):(this.expandedPresets.add(e),o.style.display="block",r.style.transform="rotate(180deg)"))}}addPreset(e,t){const o=this.generateId("preset"),r={id:o,name:`Preset ${(e.presets||[]).length+1}`,action:"turn_on",entities:[],brightness:255,hs_color:[0,0],text_color:"var(--text-primary-color)",icon_color:"var(--primary-color)",button_color:"var(--primary-color)",use_light_color_for_icon:!1,use_light_color_for_button:!0,use_icon_color_for_text:!1,smart_color:!0,button_style:"filled",show_label:!0,border_radius:8,enable_color:!0,enable_color_temp:!0};this.expandedPresets.add(o),t({presets:[...e.presets||[],r]}),this.triggerPreviewUpdate()}getPresetColorMode(e){if((e.rgb_color||e.hs_color||e.xy_color)&&void 0!==e.color_temp){if(e.hs_color)return"hs";if(e.rgb_color)return"rgb";if(e.xy_color)return"xy"}return e.color_temp?"color_temp":e.hs_color?"hs":e.xy_color?"xy":e.rgb_color?"rgb":"hs"}getPresetLightMode(e){return e.effect&&""!==e.effect.trim()?"effect":e.color_temp?"white":(e.rgb_color||e.hs_color||e.xy_color,"color")}exportPresets(e){const t={presets:e.presets||[],exported_at:(new Date).toISOString(),version:"1.0"},o=JSON.stringify(t,null,2),r=new Blob([o],{type:"application/json"}),i=URL.createObjectURL(r),n=document.createElement("a");n.href=i,n.download="ultra-card-light-presets.json",n.click(),URL.revokeObjectURL(i)}importPresets(e,t,o,r){try{if(!e.trim())return;const i=JSON.parse(e);if(i.presets&&Array.isArray(i.presets)){const e=i.presets.map(e=>Object.assign(Object.assign({},e),{id:this.generateId("preset")})),n=this._detectLightPresetEntities(e);if(n.length>0&&r)this._showLightPresetMappingDialog(e,n,t,o,r);else{o({presets:[...t.presets||[],...e]}),this.triggerPreviewUpdate();const r=new CustomEvent("hass-notification",{detail:{message:`Successfully imported ${e.length} presets`}});document.dispatchEvent(r)}}}catch(e){const t=new CustomEvent("hass-notification",{detail:{message:"Failed to import presets: Invalid JSON format"}});document.dispatchEvent(t)}}_detectLightPresetEntities(e){const t=new Map;return e.forEach((e,o)=>{e.entities&&Array.isArray(e.entities)&&e.entities.forEach((r,i)=>{var n;if(t.has(r)){const s=t.get(r);s.locations.push(`presets[${o}].entities[${i}]`),e.name&&!(null===(n=s.context)||void 0===n?void 0:n.includes(e.name))&&(s.context=s.context?`${s.context}, ${e.name}`:e.name)}else t.set(r,{entityId:r,locations:[`presets[${o}].entities[${i}]`],moduleType:"light",context:e.name})})}),Array.from(t.values())}_showLightPresetMappingDialog(e,t,o,r,i){i&&p.n.show(i,"Map Entities for Light Presets",t,t=>{console.log("✅ Apply light preset mappings:",t);const i=this._applyMappingsToLightPresets(e,t),n=[...o.presets||[],...i];r({presets:n}),this.triggerPreviewUpdate();const s=new CustomEvent("hass-notification",{detail:{message:`Successfully imported ${i.length} presets with ${t.length} entity mapping(s)`}});document.dispatchEvent(s)},()=>{console.log("❌ Cancel light preset mapping");const t=[...o.presets||[],...e];r({presets:t}),this.triggerPreviewUpdate();const i=new CustomEvent("hass-notification",{detail:{message:`Successfully imported ${e.length} presets`}});document.dispatchEvent(i)})}_applyMappingsToLightPresets(e,t){if(0===t.length)return e;const o=new Map;return t.forEach(e=>o.set(e.original,e.mapped)),e.map(e=>{var t;return Object.assign(Object.assign({},e),{entities:(null===(t=e.entities)||void 0===t?void 0:t.map(e=>o.get(e)||e))||[]})})}async applyPreset(e,t,r,i){var n,s,a;if(t.confirm_actions&&!await h.W.confirm("Apply Preset",`Apply preset "${e.name}"?`,{confirmText:"Apply"}))return;if(!1!==(null==i?void 0:i.haptic_feedback)){const{forwardHaptic:e}=await Promise.resolve().then(o.bind(o,1340));e("medium")}const l=e.entities||[];if(0===l.length){const e=new CustomEvent("hass-notification",{detail:{message:"No entities configured for this preset"}});return void document.dispatchEvent(e)}const c=e.action||"turn_on";for(const o of l){const l=this.resolveEntity(o,i)||o;if("turn_off"===c){await this.callLightService("turn_off",l,{},r);continue}const d={},p=r.states[l],h="wled"===(null==p?void 0:p.attributes.integration)||"wled"===(null==p?void 0:p.attributes.device_class)||(null==p?void 0:p.attributes.effect_list)&&p.attributes.effect_list.length>50||(null==p?void 0:p.entity_id)&&p.entity_id.toLowerCase().includes("wled")||(null==p?void 0:p.attributes.friendly_name)&&p.attributes.friendly_name.toLowerCase().includes("wled")||(null==p?void 0:p.attributes.friendly_name)&&p.attributes.friendly_name.toLowerCase().includes("glorb"),g=e.transition_time||t.default_transition_time;!(g&&g>0)||h&&e.effect&&""!==e.effect.trim()||(d.transition=g),void 0!==e.brightness&&(d.brightness=e.brightness);const u=null===(n=e.enable_color)||void 0===n||n,b=null===(s=e.enable_color_temp)||void 0===s||s,m=u&&(void 0!==e.rgb_color||void 0!==e.hs_color||void 0!==e.xy_color),f=b&&void 0!==e.color_temp,v=void 0!==e.white,_=void 0!==e.rgbw_color,x=void 0!==e.rgbww_color,y=e.effect&&""!==e.effect.trim();if(m&&f&&!y){const t=Object.assign({},d);u?void 0!==e.rgb_color?t.rgb_color=e.rgb_color:void 0!==e.hs_color?t.hs_color=e.hs_color:void 0!==e.xy_color?t.xy_color=e.xy_color:t.rgb_color=[255,255,255]:t.rgb_color=[255,255,255],delete t.color_temp,delete t.white,delete t.rgbw_color,delete t.rgbww_color,h&&(t.effect="Solid");const o=Object.assign({},d);if(b&&e.color_temp&&(o.color_temp_kelvin=Math.round(1e6/e.color_temp)),delete o.rgb_color,delete o.hs_color,delete o.xy_color,delete o.rgbw_color,delete o.rgbww_color,delete o.white,h&&(o.effect="Solid"),"toggle"===c&&"on"===(null===(a=r.states[l])||void 0===a?void 0:a.state)){await this.callLightService("turn_off",l,{},r);continue}const i="turn_on";u&&await this.callLightService(i,l,t,r),b&&(u&&await new Promise(e=>setTimeout(e,100)),await this.callLightService(i,l,o,r));continue}const w=Object.assign({},e);if(y||(x?(delete w.rgb_color,delete w.hs_color,delete w.xy_color,delete w.color_temp,delete w.rgbw_color,delete w.white):_?(delete w.rgb_color,delete w.hs_color,delete w.xy_color,delete w.color_temp,delete w.white):v?(delete w.rgb_color,delete w.hs_color,delete w.xy_color,delete w.color_temp):f&&m?(delete w.rgb_color,delete w.hs_color,delete w.xy_color):m&&delete w.white),e.effect&&""!==e.effect.trim())if(this.getEffectList(l,r).includes(e.effect))d.effect=e.effect,delete d.rgb_color,delete d.hs_color,delete d.xy_color,delete d.color_temp,delete d.rgbw_color,delete d.rgbww_color,delete d.white,h&&delete d.transition;else{const t=this.getEffectList(l,r),o=this.findSimilarEffect(e.effect,t);o&&(d.effect=o,delete d.rgb_color,delete d.hs_color,delete d.xy_color,delete d.color_temp,delete d.rgbw_color,delete d.rgbww_color,delete d.white)}else void 0!==w.color_temp&&!m&&b?d.color_temp_kelvin=Math.round(1e6/w.color_temp):h&&void 0!==w.rgb_color&&u?(d.rgb_color=w.rgb_color,d.effect="Solid"):void 0!==w.hs_color&&u?(d.hs_color=w.hs_color,h&&(d.effect="Solid")):void 0!==w.xy_color&&u?(d.xy_color=w.xy_color,h&&(d.effect="Solid")):void 0!==w.rgb_color&&u?(d.rgb_color=w.rgb_color,h&&(d.effect="Solid")):void 0!==w.rgbw_color?d.rgbw_color=w.rgbw_color:void 0!==w.rgbww_color?d.rgbww_color=w.rgbww_color:void 0!==w.white&&(d.white=w.white);const k="toggle"===c?"toggle":"turn_on";await this.callLightService(k,l,d,r)}if(!1!==t.show_feedback){const t=new CustomEvent("hass-notification",{detail:{message:`Applied preset "${e.name}" to ${l.length} ${1===l.length?"entity":"entities"}`}});document.dispatchEvent(t)}}deletePreset(e,t,o){const r=[...t.presets||[]];r.splice(e,1),o({presets:r}),this.triggerPreviewUpdate()}renderPreview(e,t,o,i){var n,s;const a=e,l=a.presets||[],c=this.getHoverEffectClass(e),d=this.buildStyleString(this.buildDesignStyles(e,t));if(0===l.length)return r.qy`
        <div class="light-module-container ${c}" style="${d}">
      ...
      `}const g=a.layout||"buttons",u=null===(n=a.show_labels)||void 0===n||n,b=a.button_style||"filled",m=a.columns||3,f=a.button_alignment||"center",v=null===(s=a.allow_wrapping)||void 0===s||s,_=a.button_gap||.8;let x="";x="grid"===g?`\n        display: grid;\n        grid-template-columns: repeat(${m}, 1fr);\n        grid-auto-flow: ${!1===v?"column":"row"};\n        gap: ${_}rem;\n      `:`\n        display: flex;\n        flex-wrap: ${v?"wrap":"nowrap"};\n        justify-content: ${this.getJustifyContent(f)};\n        align-items: center;\n        gap: ${_}rem;\n      `;const y=h.length>0?r.qy`
          ...
          `:"";return this.wrapWithAnimation(r.qy`
      <div class="light-module-container ${c}" style="${d}">
        ${y}
        <div class="presets-container ${g}" style="${x}">
          ${p.map(e=>this.renderPresetButton(e,a,t,u,b,o))}
        </div>
      </div>
    `,e,t)}getPaddingCSS(e){return e.padding_top||e.padding_bottom||e.padding_left||e.padding_right?`${this.addPixelUnit(e.padding_top)||"8px"} ${this.addPixelUnit(e.padding_right)||"8px"} ${this.addPixelUnit(e.padding_bottom)||"8px"} ${this.addPixelUnit(e.padding_left)||"8px"}`:"16px"}getMarginCSS(e){return e.margin_top||e.margin_bottom||e.margin_left||e.margin_right?`${this.addPixelUnit(e.margin_top)||"0"} ${this.addPixelUnit(e.margin_right)||"0"} ${this.addPixelUnit(e.margin_bottom)||"0"} ${this.addPixelUnit(e.margin_left)||"0"}`:"0"}getBackgroundCSS(e){return e.background_color||"var(--card-background-color)"}getBackgroundImageCSS(e,t,o){if("url"===e.background_image_type&&e.background_image)return`url(${e.background_image})`;if("entity"===e.background_image_type&&e.background_image_entity){const r=this.resolveEntity(e.background_image_entity,o)||e.background_image_entity,i=t.states[r];if(i&&i.attributes.entity_picture)return`url(${i.attributes.entity_picture})`}return"none"}getBorderCSS(e){return e.border_style&&"none"!==e.border_style?`${this.addPixelUnit(e.border_width)||"1px"} ${e.border_style} ${e.border_color||"var(--divider-color)"}`:"none"}addPixelUnit(e){return e?"auto"===e||"none"===e||"inherit"===e?e:/^\d+$/.test(e)?`${e}px`:/^[\d\s]+$/.test(e)?e.split(" ").map(e=>e.trim()?`${e}px`:e).join(" "):e:e}styleObjectToCss(e){return Object.entries(e).map(([e,t])=>`${this.camelToKebab(e)}: ${t}`).join("; ")}camelToKebab(e){return e.replace(/([a-z0-9]|(?=[A-Z]))([A-Z])/g,"$1-$2").toLowerCase()}getJustifyContent(e){switch(e){case"left":return"flex-start";case"center":default:return"center";case"right":return"flex-end";case"space-between":return"space-between";case"space-around":return"space-around";case"space-evenly":return"space-evenly"}}getDefaultIconForAction(e){switch(e){case"turn_off":return"mdi:lightbulb-off";case"toggle":return"mdi:lightbulb-auto";default:return"mdi:lightbulb"}}renderPresetButton(e,t,o,i,n,s){var a,l;const c=e.entities&&e.entities.length>0,d=e.button_style||n,p=null!==(a=e.show_label)&&void 0!==a?a:i,h=this.getPresetColors(e,o);let g=`\n      display: flex;\n      align-items: center;\n      justify-content: center;\n      gap: 8px;\n      padding: 12px 16px;\n      border-radius: ${null!==(l=e.border_radius)&&void 0!==l?l:8}px;\n      cursor: pointer;\n      font-size: 14px;\n      font-weight: 500;\n      transition: all 0.2s ease;\n      min-height: 48px;\n      position: relative;\n      overflow: hidden;\n      box-sizing: border-box;\n    `;return"filled"===d?h.buttonColor.startsWith("linear-gradient")?g+=`background: ${h.buttonColor}; color: ${h.textColor}; border: none;`:g+=`background-color: ${h.buttonColor}; color: ${h.textColor}; border: none;`:"outlined"===d?g+=`border: 2px solid ${h.buttonColor}; color: ${h.textColor}; background: transparent;`:"text"===d&&(g+=`color: ${h.textColor}; background: transparent; border: none;`),r.qy`
